...
def train():
    ...
    for i in range(nb_iter):
        ...
        if calc_crps > 0 and i % calc_crps == 0:
            ...
            cdf_pred_systole = real_to_cdf(pred_systole, math.sqrt(loss_systole))
            cdf_pred_diastole = real_to_cdf(pred_diastole, math.sqrt(loss_diastole))
            cdf_val_pred_systole = real_to_cdf(val_pred_systole, math.sqrt(val_loss_systole))
            cdf_val_pred_diastole = real_to_cdf(val_pred_diastole, math.sqrt(val_loss_diastole))
